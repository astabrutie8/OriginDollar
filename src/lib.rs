...
#[derive(Debug)]
pub struct OriginDollarProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OriginDollarProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OriginDollar processing");
    
    let mut processor = OriginDollarProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OriginDollarProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OriginDollarProcessor::new(false);
